...
(function (factory) {
    ...
    var Comments = {
        ...
        updateToggleAllButton: function(parentEl) {
            ...
            if (this.options.maxRepliesVisible == "") return;//null
        ...
        upvoteComment: function(ev) {
            ...
            var newUpvoteCount,newuserHasUpvoted;
            if(commentModel.userHasUpvoted=="true") {//update 2019-01-31 源程序没有=="true"
                newUpvoteCount = previousUpvoteCount ;//- 1;此处需要重构TODO
                newuserHasUpvoted ="false";//update 2019-01-31
            } else {
                newUpvoteCount = previousUpvoteCount + 1;
                newuserHasUpvoted = "true";//update 2019-01-31
            }

            // Show changes immediately
            commentModel.userHasUpvoted = !commentModel.userHasUpvoted;
            commentModel.upvoteCount = newUpvoteCount;
            commentModel.userHasUpvoted =newuserHasUpvoted;//update 2019-01-31
        ...
        createCommentElement: function(commentModel) {
            ...
            if(commentModel.createdByCurrentUser=="true") commentEl.addClass('by-current-user');//update 2019-01-31 add =="true"
            if(commentModel.createdByAdmin=="true") commentEl.addClass('by-admin');
            ...
            if(commentModel.parent == "") commentEl.append(childComments);//null 此处对回复键起作用
            return commentEl;
        },
        ...
        createCommentWrapperElement: function(commentModel) {
            ...
            // Name element
            var name = $('<span/>', {
                'data-user-id': commentModel.creator,//update 2019-01-31
                'text': commentModel.createdByCurrentUser=="true" ? this.options.textFormatter(commentModel.fullname) : this.options.youText//commentModel.createdByCurrentUser ? this.options.textFormatter(this.options.youText) : commentModel.fullname
            });
            ...
            if(commentModel.createdByAdmin=="true") nameEl.addClass('highlight-font-bold');
            ...
            // New tag
            if(commentModel.isNew=="true") {//update 2019-01-31 add =="true"
                var newTag = $('<span/>', {
        ...
        createUpvoteElement: function(commentModel) {
            ...
            // Upvotes
            var upvoteEl = $('<button/>', {
                'class': 'action upvote' + (commentModel.userHasUpvoted=="true" ? ' highlight-font' : '')//commentModel.userHasUpvoted源程序去掉=="true"
            }).append($('<span/>', {
        ...
        createCommentJSON: function(textarea) {
            ...
            var commentJSON = {
                ...
                parent: textarea.attr('data-parent') || "",
                created: time,
                modified: time,
                content: this.getTextareaContent(textarea),
                pings: this.getPings(textarea),
