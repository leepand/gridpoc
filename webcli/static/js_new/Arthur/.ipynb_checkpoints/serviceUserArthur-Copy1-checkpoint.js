    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if(data.code == 201){
                ...
                if(!data.result){
                    $("table").append('<td>暂无 服务可发布，赶快添加吧</td>'); 
                    $("#data_count").html("0");
                    return;
                }
                ...
                for(var i = 0; i < dataLen; i++){
                    ...
                    $("table").append(
                        ...
                        "<td>"+ remark +"</td>"+
                        "<td>"+ insert_tm +"</td>"+
                        "<td><div><a  class='layui-btn layui-btn-xs'  onclick=publish_service('"+aid+"') >发布</a>  <a class='layui-btn layui-btn-xs layui-btn-danger' onclick=unpublish_service('"+ aid +"')>下线</a></div></td></tr>"//需要加载layui的样式del_user
                    );
