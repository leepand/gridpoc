...
function initProfile() {
    ...
    $("#profile-firstname").val('lee');//User.first_name
    $("#profile-lastname").val('pand');//User.last_name
    $("#profile-email").val('pandeng.li@163.com');//User.email
    ...
    $("#profile-height").val('`182');//User.userprofile.height
    ...
    $('#profle-birth-date').datepicker('setDate', new Date('1985-01-12'));//User.userprofile.birth_date
