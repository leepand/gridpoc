...
#render = web.template.render(curPath + '/../templates', base='header',globals=t_globals)
print settings.CUR_DIR % 'templates/'
render = web.template.render(settings.CUR_DIR % 'templates/', base='base',globals=t_globals)
render_without_base = web.template.render(settings.CUR_DIR % 'templates/')
