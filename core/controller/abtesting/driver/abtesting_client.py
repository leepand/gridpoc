...
ARTHUR_ABTESTING_HOST = 'http://localhost:8001'
ARTHUR_ABTESTING_TIMEOUT = 0.5
...
class SessionDriver(object):
    ...
    def __init__(self, client_id=None, options=None, params=None):
        use_options = {
            'host': ARTHUR_ABTESTING_HOST,
            'timeout': ARTHUR_ABTESTING_TIMEOUT
        }
    ...
    def get_response(self, endpoint=None, params=None):
        ...
        try:
            ...
            return {"status": "failed", "response": "http error: Arthur A/B testing server is unreachable"}
