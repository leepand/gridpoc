...
class Apifly(object):
    ...
    def add_route(self, path, function, function_name=None, **kwargs):
        self.mapping[path] = ApiflyFunction(function, function_name, **kwargs)
...
class ApiflyFunction(object):
    ...
    def __repr__(self):
        return "<ApiflyFunction %r>" % self.function
